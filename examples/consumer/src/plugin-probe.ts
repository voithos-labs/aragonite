...
export type MermaidRendererProbe =
	typeof import('@voithos-labs/aragonite/plugins/mermaid/renderer').mermaidRenderer;
...
export type TestingSurfaceProbe = {
	reset: typeof import('@voithos-labs/aragonite/testing').resetPluginPlatformForTests;
	containerConformance: typeof import('@voithos-labs/aragonite/testing').runContainerConformance;
	kindConformance: typeof import('@voithos-labs/aragonite/testing').runKindConformance;
	inlineKindConformance: typeof import('@voithos-labs/aragonite/testing').runInlineKindConformance;
};
