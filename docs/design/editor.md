...
| `fencedCode`              | Live syntax-highlighted code surface. Dimmed fence and info-string markers, which take edits where the mode paints them and are out of reach where it hides them. Participates in sticky-column traversal.                                                                                                                                                         |
