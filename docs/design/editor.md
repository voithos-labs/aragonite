...
- **Paste.** Always intercepted. Any active selection is deleted first, the whole delete-then-paste collapses into one undo entry, and focus lands at the end of the pasted content, inside whichever block holds it once the fix-up has folded the text after the caret into the last pasted block.
