...
| `thematicBreak`           | Non-editable, focusable, reorderable. Declares no `blockFocus`, so a caret-adjacent Backspace deletes it on the first press rather than focusing it. Its closure cells say otherwise, ledgered in `docs/issues.md`.                                                                                                                                                 |
