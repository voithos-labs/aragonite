...
| E2E specs (Playwright)  | console lines carrying either prefix, plus uncaught page errors and rejections (tag `pageerror`)                                    | the spec whose page emitted one, at teardown                                                                              |
