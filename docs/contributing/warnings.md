...
| E2E specs (Playwright)  | console lines carrying either prefix, plus uncaught page errors (`pageerror`) and `Unhandled error` console lines (`unhandled`)     | the spec whose page emitted one, at teardown                                                                              |
