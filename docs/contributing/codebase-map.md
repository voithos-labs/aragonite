...
| Arrow at a block boundary   | `src/lib/selection/shared-keydown.ts` :: `handleSharedKeydown`                                                                                                                 | Boundary tests read geometry (the first/last visual line), not offsets                                                                               | `docs/design/editor.md` § 8                            |
