...
**Parser opener**. Placement rules are in [Opener priority](#opener-priority).
...
**Commands and keybindings** _(pre-freeze / unstable)_. Dispatch tiers are in [Block commands](#block-commands).
