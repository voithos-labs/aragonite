...
| Export                   | Role                                                                                                                                                                                                                                                                                                                                                                                                            |
| ------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `InlineMenuRegistry`     | The `editor.inlineMenus` surface: `addSource` registers a source and returns its handle, `open(name)` types a source's trigger at the caret and opens its list (what a shortcut or a toolbar button calls), `close()` dismisses, and `isOpen` is true while a list is on screen                                                                                                                                 |
...
| `InlineMenuItem`         | One row: an `id`, a `label`, an optional dim `detail`, and `insert`, the bytes that replace the trigger and the query. One line of inline bytes, empty allowed; a line break is refused and reported, and a block belongs in `onCommit`                                                                                                                                                                         |
