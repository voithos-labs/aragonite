...
| `trailingLineEnding`                      | The ending a line rebuilt from a block's bytes takes: the block's own, else the fallback you pass (`documentLineEnding`, or `firstLineEnding` of the block when you have no document)              |
