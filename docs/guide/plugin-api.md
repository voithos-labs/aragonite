...
| Export                 | Role                                                                                                                                                                                                                                                                                                                                                                          |
| ---------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `POINTER_GESTURE_ATTR` | Put it on the element whose drags are yours, and a press anywhere inside that element is left alone by the editor's drag-to-select and by the click ladder above the caret. The editor reads it at press time, so the declaration may be permanent or conditional: drop it while your gesture is disarmed and the editor answers those presses as it would on any other block |
