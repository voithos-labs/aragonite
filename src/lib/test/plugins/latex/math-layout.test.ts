...
// The host's choice reaches the block two ways, this editor's plugin options and then the
// factory default, and an unknown value falls through rather than breaking the block.
