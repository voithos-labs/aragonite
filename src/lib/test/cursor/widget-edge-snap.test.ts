...
describe('nearestWidgetEdgeSeat', () => {
	...
	it('declines a point inside a whole-select island, which owns its own click', () => {
	...
	it('marks the inside seat, which no engine caret of the point’s own stands against', () => {
