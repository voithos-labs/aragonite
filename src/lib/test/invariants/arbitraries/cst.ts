...
/**
 * Parsed `Document` trees for suites that mutate or traverse a tree. Both source generators feed
 * it because an indent changes the shape: four spaces turn a marker into indented code, so a
 * container the unindented draw would have built becomes a leaf.
 */
