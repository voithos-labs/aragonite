...
// The collapsed-caret contract (docs/changelog.md 0.9.36): insert the empty pair
// and land the caret between its halves, unless the caret already sits inside a
// span of that format (unwrap it) or between the halves of a pair (remove it).
