 ...
 * sits, so `beforeinput` and `compositionend` have somewhere to fire. Always scoped to one
 * block: a document-wide locator would match the wrong diagram in a multi-block fixture.
 */
