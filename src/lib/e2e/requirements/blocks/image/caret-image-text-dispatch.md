...
- After typing trailing text into an image-only paragraph, ArrowUp from the next paragraph lands in that paragraph's trailing text, never inside "text1" above it
