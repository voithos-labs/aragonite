...
extension moves a whole row; at the last or first row it exits the table into a
...
- Every Shift+ArrowDown used to snap the focus to cellIdx 0 (the table's own
  ...
  stepped to the next cell in document order (across), not down a row.
