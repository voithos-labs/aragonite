...
- Reveal eq1, click eq2: ONE sequenced fold→reveal gesture — eq1 re-renders, eq2's source reveals live for typing where the press landed (its tail, inside the closing `$`), and the CST holds both originals.
