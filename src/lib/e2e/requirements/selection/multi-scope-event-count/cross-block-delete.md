...
Miss-analysis (#74): no test missed anything; the fix commit flipped the spec but not this paragraph, and the issue was later filed from the stale prose. Requirement status reconciles against the spec, never against its own text.
