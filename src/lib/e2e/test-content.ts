...
export const SHOWCASE_PLUGIN_CONTENT = [
	...
	'',
	':::caution Heads up',
	'<!-- Paste a GitHub alert (a `> [!NOTE]` blockquote) to watch the admonitions paste transform rewrite it to a `:::note` directive in place. -->',
	'A titled caution.',
	':::',
	'',
	'## Collapsible details',
	...
	'',
	'A `<details>` block renders collapsed until you open it. The body is real Markdown:',
	'',
	'- one point',
	'- another point',
	'',
	...
	'## Math',
	'',
	'Inline math flows in a sentence: the relation $E = mc^2$ and the identity $a^2 + b^2 = c^2$ render in place. Block math stands alone:',
	'',
	'$$',
	...
	'## Diagrams',
	'',
	'A mermaid diagram renders as a picture; click it to edit the source.',
	'',
	'```mermaid',
	'graph TD',
	'\tA[Parse] --> B[Render]',
	...
	'```',
	'',
	'An invalid diagram resolves to a legible error instead of throwing:',
	'',
	'```mermaid',
	'notadiagram',
	'broken',
