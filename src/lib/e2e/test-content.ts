...
export const SHOWCASE_PLUGIN_CONTENT = [
	...
	'',
	':::caution Heads up',
	'Paste a GitHub alert blockquote anywhere to watch the paste transform rewrite it into a directive.',
	'A titled caution.',
	':::',
	'',
	'## Collapsible details',
	...
	'## Diagrams',
	'',
	'A mermaid diagram renders as a picture; double-click it to edit the source.',
	'',
	'```mermaid',
	'graph TD',
	'\tA[Parse] --> B[Render]',
