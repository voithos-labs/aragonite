...
// Simulate the mouse-drag repro: Range.setStart inside the contenteditable="false" checkbox text,
// setEnd at the end of "pending". Chromium permits that forward range (rooted in a non-editable
// island); it is the DELETE it then refuses silently without the fix.
