...
// The documents whose block joins the gap caret rests in, and the gesture that arrives there.
...
/** The unit harness cannot see a windowing flush, so these cases need a real render window. */
