...
/**
 * The paste half of the `</details>` terminator escape (GH #40): the clipboard is the one way
 * bytes reach a body without going through the node operations, so the container's `bodyWrite`
 * escape must run inside the paste path too. Requirements: details-terminator-paste.md.
 */
