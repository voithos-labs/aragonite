...
// Center pixel of the first visible text node containing `word` — used to click a
// marker-adjacent word without relying on raw-offset geometry (the hidden markers
